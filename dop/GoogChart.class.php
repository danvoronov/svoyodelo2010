...
class GoogChart
{
	...
	protected $background = 'bg,s,65432100'; //   	bg          : 'FFFFFF00',   
	...
	*/
	...
	protected function setBarsize( $barsize )
	{
	...
	*/
	...
	protected function setMaxData( $maxdata )
	{
